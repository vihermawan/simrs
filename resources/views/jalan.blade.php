                                ...
                                <form action="#">
                                        ...
                                        <div class="col-lg-9">
                                            <select class="form-control form-control-select2 select2-hidden-accessible"
                                                ...
                                                dir="ltr" style="width: 100%;"><span class="selection"><span
                                                        ...
                                                        tabindex="0" aria-labelledby="select2-0ztl-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-0ztl-container"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <div class="uniform-choice"><span class="checked"><input
                                                                type="radio" class="form-input-styled" name="gender"
                                                                checked="" data-fouc=""></span></div>
                                                    Male
                                                </label>
                                            </div>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                    <div class="uniform-choice"><span><input type="radio"
                                                                class="form-input-styled" name="gender"
                                                                data-fouc=""></span></div>
                                                    Female
                                                </label>
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="uniform-uploader"><input type="file" class="form-input-styled"
                                                    data-fouc=""><span class="filename" style="user-select: none;">No
                                                    file selected</span><span class="action btn bg-pink-400"
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Tags:</label>
                                        <div class="col-lg-9">
                                            <select multiple="" data-placeholder="Enter tags"
                                                class="form-control form-control-select2-icons select2-hidden-accessible"
                                                data-fouc="" tabindex="-1" aria-hidden="true">
                                                <optgroup label="Services">
                                                    <option value="wordpress2" data-icon="wordpress2">Wordpress</option>
                                                    <option value="tumblr2" data-icon="tumblr2">Tumblr</option>
                                                ...
                                                <optgroup label="Browsers">
                                                    <option value="chrome" data-icon="chrome" selected="">Chrome
                                                    </option>
                                                ...
                                                dir="ltr" style="width: 100%;"><span class="selection"><span
                                                        ...
                                                        <ul class="select2-selection__rendered">
                                                            <li class="select2-selection__choice" title="Chrome"><span
                                                                    class="select2-selection__choice__remove"
                                                                    role="presentation">×</span><i
                                                                    class="icon-chrome"></i>Chrome</li>
                                                            <li class="select2-selection__choice" title="Firefox"><span
                                                                    class="select2-selection__choice__remove"
                                                                    role="presentation">×</span><i
                                                                    class="icon-firefox"></i>Firefox</li>
