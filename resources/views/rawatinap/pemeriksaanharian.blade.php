        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Tindakan</span>
                </div>
            ...
            <div class="col-xl-12">
                ...
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h5 class="card-title">Tabel Pemeriksaan Harian</h5>
                        ...
                        <div class="col-lg-4">
                            <button type="button" class="btn bg-success btn-labeled btn-labeled-left"
                                data-toggle="modal" data-target="#modal_theme_success"><b><i
                                        class="icon-reading"></i></b> Tambah Tindakan </button>
                        </div>
                    </div>
                    ...
                    <table class="table table-togglable table-hover footable-loaded footable default">
                        <thead>
                            <tr>
                                ...
                                <th data-hide="phone,tablet" data-name="Date Of Birth" class="footable-visible">Tanggal Pemeriksaan</th>
                                <th data-hide="phone,tablet" data-name="Date Of Birth" class="footable-visible">Tindakan</th>
                        ...
                        <tbody>
                            <tr>
                            @php $no = 1; @endphp
                            @foreach ($pemeriksaanharian as $data)
                                ...
                                <td class="footable-visible"><span class="badge badge-success">{{$data->tanggal_periksa_harian}}</span></td>
                    ...
                    <div class="modal-body">
                        <div class="col-xl-12">
                            ...
                            <div class="card-body">
                                <form action="#">
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">ID Tindakan:</label>
                                        <div class="col-lg-9">
                                            <input type="number" class="form-control" placeholder="Masukkan ID Tindakan">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Nama:</label>
                                        <div class="col-lg-9">
                                            <input type="nama" class="form-control" placeholder="Masukkan Nama ">
                                        </div>
                                    </div>
                                    <div class="form-group row">
