        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card">
                        ...
                        <div class="card-body">
                            <div class="col-lg-4">
                                <button type="button" class="btn bg-teal-400 btn-labeled btn-labeled-left" data-toggle="modal" data-target="#modal_theme_success"><b><i class="icon-reading"></i></b> Tambah Transaksi Inap</button>
                            </div>
                        </div>
